...
export const MultiSelectGroup = (props: ComponentPropsWithoutRef<typeof CommandGroup>) => {
  return <CommandGroup {...props} />;
};

export const MultiSelectSeparator = (props: ComponentPropsWithoutRef<typeof CommandSeparator>) => {
